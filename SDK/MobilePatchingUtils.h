...
class UMobileInstalledContent : public UObject : UObject
{ 
public:
...
class UMobilePendingContent : public UMobileInstalledContent : UMobileInstalledContent
{ 
public:
...
class UMobilePatchingLibrary : public UBlueprintFunctionLibrary : UBlueprintFunctionLibrary
{ 
public:
};
