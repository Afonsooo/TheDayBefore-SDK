...
class UAnimationBudgetBlueprintLibrary : public UBlueprintFunctionLibrary : UBlueprintFunctionLibrary
{ 
public:
};

/// Class /Script/AnimationBudgetAllocator.SkeletalMeshComponentBudgeted
/// Size: 0x0030 (0x000FD0 - 0x001000)
class USkeletalMeshComponentBudgeted : public USkeletalMeshComponent : USkeletalMeshComponent
{ 
public:
	unsigned char                                      UnknownData00_2[0x20];                                      // 0x0FD0   (0x0020)  MISSED
	...
	unsigned char                                      UnknownData01_6[0xF];                                       // 0x0FF1   (0x000F)  MISSED


	/// Functions
	// Function /Script/AnimationBudgetAllocator.SkeletalMeshComponentBudgeted.SetAutoRegisterWithBudgetAllocator
	void SetAutoRegisterWithBudgetAllocator(bool bInAutoRegisterWithBudgetAllocator);                                        // [0x15a0fe0] Final|Native|Public|BlueprintCallable 
};
