...
class UNiagaraDataInterfaceChaosDestruction : public UNiagaraDataInterface : UNiagaraDataInterface
{ 
public:
	...
	TSet<UPhysicalMaterial*>                           ChaosBreakingMaterialSet;                                   // 0x01C0   (0x0050)  
...
class UNiagaraDataInterfaceGeometryCollection : public UNiagaraDataInterface : UNiagaraDataInterface
{ 
public:
	AGeometryCollectionActor*                          GeometryCollectionActor;                                    // 0x0038   (0x0008)  
};

/// Class /Script/ChaosNiagara.NiagaraDataInterfacePhysicsField
/// Size: 0x0000 (0x000038 - 0x000038)
class UNiagaraDataInterfacePhysicsField : public UNiagaraDataInterface : UNiagaraDataInterface
{ 
public:
};
